...
int main(int argc, char* argv[]) {
  ...
  while (infile >> cadena >> alfabeto) {
    ...
    switch (opcode) {
      ...
      case 6:
        Language lenguaje_prefijos{chain.prefijos()};
        Language lenguaje_subcadenas{chain.subcadenas()};
        outfile << "Lp: " << lenguaje_prefijos << "\n";
        outfile << "Ls: " << lenguaje_subcadenas << "\n";
        outfile << "Lp.Ls: " << lenguaje_prefijos.concatenar(lenguaje_subcadenas) << "\n";
    }
